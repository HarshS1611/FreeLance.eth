      ...
      <header className="top-0 z-50 grid grid-cols-2 bg-black drop-shadow-md p-5 md:px-10">
        ...
        <Link href="/home">
          <div className="relative flex items-center h-15 cursor-pointer my-auto">
            <h1 className="text-3xl font-bold text-white">FreeLance</h1>
          </div>
        </Link>
        {/* right */}
        <div className="flex space-x-4 items-center justify-end text-gray-500">
          ...
          <button className="hidden md:flex items-center bg-transparent text-white text-lg px-5 py-2 border border-white-500 rounded-xl">
            My Projects
          </button>
        </div>
      </header>
