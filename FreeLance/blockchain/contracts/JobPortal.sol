...
contract JobPortal {
    ...
    function getTaskCountByProjectId(
        uint projectId
    ...
    function selectWorker(uint projectId, uint taskId, address worker) public {
        ...
        for (
            ...
            if (
                projects[projectId].tasks[taskId].proposals[i].freelancer ==
                worker
            ) {
                projects[projectId]
                    .tasks[taskId]
    ...
    function reviewTask(uint projectId, uint taskId) public {
        require(
            msg.sender == projects[projectId].projectManager,
            "Only project manager can review Task"
        );
        require(
            projects[projectId].tasks[taskId].completed,
    ...
    function releasePayment(uint projectId, uint taskId) public payable {
        require(
            msg.sender == projects[projectId].projectManager,
            "Only project manager can release payment"
        );
        require(
            projects[projectId].tasks[taskId].reviewed,
            "Task is not reviewed yet"
        );
    ...
    function increaseStakedAmount(uint projectId, uint taskId) public payable {
        require(
            msg.sender == projects[projectId].projectManager,
            "Only project manager can increase staked amount"
        );
        require(
            !projects[projectId].tasks[taskId].completed,
            "Task is already completed"
    ...
    function refundStakedAmount(uint projectId, uint taskId) public payable {
        require(
            msg.sender == projects[projectId].projectManager,
            "Only project manager can refund staked amount"
        );
        require(
            !projects[projectId].tasks[taskId].completed,
            "Task is already completed"
